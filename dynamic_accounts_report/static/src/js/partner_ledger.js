odoo.define('dynamic_accounts_report.partner_ledger', function (require) {
    ...
    template: 'PartnerTemp',
            ...
            var self = this;
                ...
                try{
                    ...
                    self._rpc({
                        ...
                        if (initial_render) {
                            console.log("ccccc",datas['filters'])
                        ...
                        var child=[];
                        console.log("99999",datas['filters'])
        ...
        apply_filter: function(event) {
            ...
            if ($(".reconciled1").length){
            var reconciled_res = document.getElementById("reconciled_res1")
            filter_data_selected.reconciled = $(".reconciled1")[0].value
            reconciled_res.value = $(".reconciled1")[0].value
//            reconciled_res.innerHTML=reconciled_res.value;
            if (reconciled_res.value == "unreconciled"){
                reconciled_res.innerHTML='Unreconciled'
            }
            else if (reconciled_res.value == "reconciled"){
                reconciled_res.innerHTML='Reconciled'
            }
            if ($(".reconciled1").value==""){
                reconciled_res.innerHTML="Unreconciled";
            ...
            self.initial_render = false;
                console.log("iiiiiiiiiiiii",filter_data_selected)
                self.load_data(self.initial_render);
            });
        },
